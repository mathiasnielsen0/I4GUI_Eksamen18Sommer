...
namespace Eksamensopgave1_MVC.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            DBFnummer = user.DBFnummer;
            AddresseLinje1 = user.AddresseLinje1;
            AddresseLinje2 = user.AddresseLinje2;
